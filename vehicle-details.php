...
<section id="listing_img_slider">
  <div><img src="assets/images/vehicle-images/<?php echo htmlentities($result->Vimage1);?>" class="img-responsive" alt="image" width="900" height="560"></div>
  <div><img src="assets/images/vehicle-images/<?php echo htmlentities($result->Vimage2);?>" class="img-responsive" alt="image" width="900" height="560"></div>
  <div><img src="assets/images/vehicle-images/<?php echo htmlentities($result->Vimage3);?>" class="img-responsive" alt="image" width="900" height="560"></div>
  <div><img src="assets/images/vehicle-images/<?php echo htmlentities($result->Vimage4);?>" class="img-responsive"  alt="image" width="900" height="560"></div>
  <?php if($result->Vimage5=="")
{

} else {
  ?>
  <div><img src="assets/images/vehicle-images/<?php echo htmlentities($result->Vimage5);?>" class="img-responsive" alt="image" width="900" height="560"></div>
  <?php } ?>
</section>
        ...
        <div class="main_features">
          <ul>
            ...
            <li> <i class="fa fa-car" aria-hidden="true"></i>
              <h5><?php echo htmlentities($result->VehiclesType);?></h5>
              <p>Vehicle Type</p>
            </li>
        ...
        <div class="listing_more_info">
          <div class="listing_detail_wrap"> 
            ...
            <div class="tab-content"> 
              ...
              <div role="tabpanel" class="tab-pane" id="rental-info">
...
{ ?>      
        <div class="col-md-3 grid_listing">
          <div class="product-listing-m gray-bg">
            <div class="product-listing-img"> <a href="vehicle-details.php?vhid=<?php echo htmlentities($result->id);?>"><img src="assets/images/vehicle-images/<?php echo htmlentities($result->Vimage1);?>" class="img-responsive" alt="image" /> </a>
            </div>
