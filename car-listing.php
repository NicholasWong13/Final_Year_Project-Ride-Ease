                    ...
                    foreach ($results as $result) {
                        ...
                        <div class="product-listing-m gray-bg">
                            <div class="product-listing-img">
                                <img src="assets/images/vehicle-images/<?php echo htmlentities($result->Vimage1); ?>"
                    ...
                    <div class="sidebar_filter">
                        <form action="search-carresult.php" method="post">
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-block"><i class="fa fa-search" aria-hidden="true"></i> Search Car
                                </button>
                            </div>
                        </form>
                    </div>
...
<div class="pagination">
    <ul>
        <?php if ($currentPage > 1): ?>
            <li><a href="car-listing.php?page=<?php echo $currentPage - 1; ?>">Previous</a></li>
        <?php endif; ?>
        ...
        <?php if ($currentPage < $totalPages): ?>
            <li><a href="car-listing.php?page=<?php echo $currentPage + 1; ?>">Next</a></li>
        <?php endif; ?>
    </ul>
</div>
