...
header('location:index.php');
    ...
    <title>Ride Ease | My Bookings </title>
    <!--Bootstrap -->
        ...
        <div class="profile_wrap">
          ...
          <div class="my_vehicles_list">
            ...
            ?>
                ...
                <a href="vehicle-details.php?vhid=<?php echo htmlentities($result->vid);?>">
                ...
                <?php echo htmlentities($result->BookingNumber);?></a><br />
                  ...
                  <b>Price/Day:</b> <?php echo htmlentities($result->PricePerDay);?></p>
