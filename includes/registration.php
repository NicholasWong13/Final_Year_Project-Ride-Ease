    ...
    <div class="modal-content">
            ...
            <div class="col-md-12 col-sm-6">
              ...
              <div class="row">
                    ...
                    <!--<div class="form-group col-md-6">
                        ...
                        <input type="text" name="fullname" id="fullname" class="form-control" placeholder=" Identification / Passport Number" required="required">
                        <span class="error" id="fullname_err"> </span>
                    </div>-->
                    <div class="form-group col-md-6">
                        <label for="username">
      ...
      <span class="error" id="password_err"> </span>
                    ...
                    <div class="form-group col-md-8 password-container">
                      ...
                      <br/><input type="password" name="password" id="password" class="form-control" placeholder="Password" required="required">
                  ...
                  <button type="button" id="togglePassword" onclick="togglePasswordVisibility()">Show</button>
                        ...
                        <br/><label for="conpassword">
                            Confirm Password:
                        </label>
                        <input type="password" name="cpass" id="cpassword" class="form-control" placeholder="Confirm Password" required="required">
                        <br/><button type="button" id="togglePassword" onclick="toggleconfirmPasswordVisibility()">Show</button>
