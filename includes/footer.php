    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-3 col-sm-6">
          <h6>About Us</h6>
          <p>We are passionate about providing convenient and reliable car rental services to our valued customers.</p>
        </div>
        ...
        <div class="col-md-3 col-sm-6">
          ...
          <li><a href="blog-listing.php">Blog</a></li>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6 col-md-pull-6">
          <p class="copy-right">Copyright &copy; 2023 Ride Ease. All Rights Reserved</p>
        </div>
      </div>
    </div>
  </div>
