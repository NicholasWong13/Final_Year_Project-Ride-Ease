...
if(strlen($_SESSION['alogin']) == 0) {
    ...
    if(isset($_POST['submit'])) {
        ...
        $status = $_POST['status'];
        $remark = $_POST['remark'];
        $sql = "UPDATE booking SET Status=:status, Remark=:remark WHERE ID=:eid";
...
<head>
	...
	<title>Ride Ease | View Booking Detail</title>
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-body">
                            <div class="table-responsive">
                                <?php
                                $eid = $_GET['editid'];
                                $sql = "SELECT * from booking where ID=:eid";
                                $query = $dbh->prepare($sql);
                                $query->bindParam(':eid', $eid, PDO::PARAM_STR);
                                $query->execute();
                                    ...
                                    foreach ($results as $row) {
                                        ...
                                        <table border="1" class="table table-bordered mg-b-0">
                                            <tr>
                                                ...
                                                <td><?php echo $aptno = ($row->BookingNumber); ?></td>
                                                <th>Patient Name</th>
