...
$sql ="SELECT ID FROM admin WHERE ID=:eid and Password=:cpassword";
...
if($query -> rowCount() > 0)
{
$con="update admin set Password=:newpassword where ID=:eid";
...
<head>
  ...
  <title>Ride Ease - Change Password</title>
