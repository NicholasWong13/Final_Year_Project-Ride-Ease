...
<head>
	...
	<title>Ride Ease | Admin Update Image 3</title>
			...
			<div class="col-md-12">
				<div class="widget">
					<header class="widget-header">
						<h4 class="widget-title">Vehicle Image 3</h4>
					</header>
...
<div class="col-sm-8">
<img src="../assets/images/vehicle-images/<?php echo htmlentities($result->Vimage3);?>" width="300" height="200" style="border:solid 1px #000">
</div>
<?php }}?>
</div>
