...
<!DOCTYPE HTML>
  <html lang="en">
	...
	<title>Ride Ease | Admin Manage Testimonials </title>
			...
			<div class="col-md-12">
				<div class="widget">
					<header class="widget-header">
						<h4 class="widget-title">Manage Testimonials</h4>
					</header>
...
<?php 
$sql = "SELECT users.Username,testimonial.UserEmail,testimonial.Testimonial,testimonial.PostingDate,testimonial.status,testimonial.id from testimonial join users on users.Emailid=testimonial.UserEmail";
$query = $dbh -> prepare($sql);
$query->execute();
