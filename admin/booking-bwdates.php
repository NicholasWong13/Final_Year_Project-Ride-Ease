...
<head>
  ...
  <title>Ride Ease - Bookings Between Dates Report</title>
      ...
      <div class="col-md-12">
        <div class="widget">
          <header class="widget-header">
            <h3 class="widget-title">Between Dates Report of Bookings</h3>
          </header>
          <hr class="widget-separator">
          <div class="widget-body">
           
            <form class="form-horizontal" method="post" name="bwdatesreport" action="booking-bwdates-reports-details.php">
