...
<section class="faq section-padding">
  <div class="container">
    <div class="section-header text-center">
      ...
      <p>To assist customers in understanding the ins and outs of Ride Ease, we provide a comprehensive FAQ section. </p>
      <p>Here's a description of what you typically expect to find in our FAQ:</p>
    </div>
    <div class="row">
      <div class="col-md-4">
        <div class="faq_category white-text knowledge_base_faq">
          <div class="div_zindex">
            <h3>Booking  <span>Process</span></h3>
          </div>
          <div class="dark-overlay"></div>
        </div>
        <div class="faq_text">
      ...
      <div class="col-md-4">
        ...
        <div class="faq_text">
          <h4>Reservations and Cancellations</h4>
